...
Shader "SH_Fresnel"
{
	Properties
	{
		...
		[ASEBegin]_EmissiveColor("EmissiveColor", Color) = (0.764151,0.5118369,0.03244036,0)
		_Scale("Scale", Float) = 3
		[ASEEnd]_Power("Power", Float) = 3
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color6 = IsGammaSpace() ? float4(0.3679245,0.3523051,0.3523051,0) : float4(0.1114872,0.1018596,0.1018596,0);
				
				float fresnelNdotV6_g4 = dot( WorldNormal, WorldViewDirection );
				float fresnelNode6_g4 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV6_g4, _Power ) );
				
				float3 Albedo = color6.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( fresnelNode6_g4 * _EmissiveColor ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNdotV6_g4 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode6_g4 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV6_g4, _Power ) );
...
/*ASEBEGIN
Version=18800
320;73;1159;695;1022.236;347.7085;1.262179;True;False
Node;AmplifyShaderEditor.ColorNode;6;-234,-181.5;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.3679245,0.3523051,0.3523051,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;17;-251.1205,106.3892;Inherit;False;MF_Fresnel;0;;4;b5c182909133c1f4f9d154797553b243;0;2;7;FLOAT;0;False;8;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-522.4136,177.358;Inherit;False;Property;_Scale;Scale;2;0;Create;True;0;0;0;False;0;False;3;1.53;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-382.3113,264.4483;Inherit;False;Property;_Power;Power;3;0;Create;True;0;0;0;False;0;False;3;1.53;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;407.661,-28.40496;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;SH_Fresnel;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
WireConnection;17;7;14;0
WireConnection;17;8;18;0
WireConnection;1;0;6;0
WireConnection;1;2;17;0
ASEEND*/
//CHKSM=BFAD457C8E777822AC0F1D6AAF69679A595D41F3